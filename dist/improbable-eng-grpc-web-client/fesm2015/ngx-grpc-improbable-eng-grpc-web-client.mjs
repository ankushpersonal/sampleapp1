...
class ImprobableEngGrpcWebClientFactory {
    ...
    createClient(serviceId, customSettings) {
        ...
        return new ImprobableEngGrpcWebClient(serviceId, Object.assign({}, settings));
    }
}
...
class ImprobableEngGrpcWebClient {
    ...
    unary(path, request, metadata, reqclss, resclss) {
        return new Observable(obs => {
            ...
            const client = grpc.unary(methodDescriptor, {
                ...
                metadata: new grpc.Metadata((_a = metadata === null || metadata === void 0 ? void 0 : metadata.toObject()) !== null && _a !== void 0 ? _a : {}),
    ...
    clientStream(path, inputStream, metadata, reqclss, resclss) {
        ...
        return new Observable(obs => {
            ...
            client.start(new grpc.Metadata((_a = metadata === null || metadata === void 0 ? void 0 : metadata.toObject()) !== null && _a !== void 0 ? _a : {}));
    ...
    castResponseMetadata({ headersMap }) {
        return new GrpcMetadata(Object.keys(headersMap).reduce((r, k) => (Object.assign(Object.assign({}, r), { [k]: headersMap[k][0] })), {}));
    }
    getTransport(key) {
